...
RUN dnf -y install https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-31.noarch.rpm && \
    dnf -y install ffmpeg python3-pip python3-flask python3-flask-sqlalchemy python3-flask-restful python3-gunicorn python3-eventlet python3-celery python3-redis python3-numpy python3-boto3 gpac && \
